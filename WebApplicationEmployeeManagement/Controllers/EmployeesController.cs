...
namespace WebApplicationEmployeeManagement.Controllers
{
    ...
    public class EmployeesController : Controller
    {
        ...
        {
            var people = db.Employees.Include(e => e.Designation);
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,Gender,Salary,DesignationID")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,Gender,Salary,DesignationID")] Employee employee)
        {
            if (ModelState.IsValid)
            {
